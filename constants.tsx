...
export const COLORS = {
  priority: {
    low: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-400 border-emerald-100 dark:border-emerald-800',
    medium: 'bg-amber-50 text-amber-700 dark:bg-amber-900/20 dark:text-amber-400 border-amber-100 dark:border-amber-800',
    high: 'bg-rose-50 text-rose-700 dark:bg-rose-900/20 dark:text-rose-400 border-rose-100 dark:border-rose-800',
  },
  status: {
    completed: 'opacity-50 grayscale scale-[0.98] blur-[0.2px]',
    pending: '',
    'in-progress': 'ring-2 ring-indigo-500 ring-offset-2 dark:ring-offset-slate-900',
  }
};
